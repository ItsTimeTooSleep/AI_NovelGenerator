...
class SummaryInterface(BaseProjectInterface):
    """
    剧情总纲界面
    ...
    def load_summary(self):
        ...
        target_file = os.path.join(filepath, "global_summary.txt")
        ...
        if has_content:
            ...
            # 显示剧情总纲占位符
            empty_state = EmptyState.summary()
            self.editorPlaceholder = PlaceholderWidget(
                empty_state["icon"],
                empty_state["title"],
                empty_state["description"],
