...
模块功能概述
================================================================================
本模块集中定义了应用程序界面中各类控件的工具提示文本。
这些提示文本帮助用户理解各配置项的含义和用法。

================================================================================
提示分类
================================================================================
1. API配置类：api_key, base_url, interface_format, model_name
2. 生成参数类：temperature, max_tokens
3. Embedding配置类：embedding_api_key, embedding_interface_format等
4. 小说参数类：title, topic, genre, num_chapters, word_number
5. 章节参数类：chapter_num, user_guidance, characters_involved等

================================================================================
设计决策
================================================================================
- 使用字典结构存储提示文本，便于通过键名快速查找
- 提示文本详细说明配置项的作用、取值范围和示例
- 支持多行文本，使用\\n换行符分隔
